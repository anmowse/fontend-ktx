...
const GiaHanHopDong = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(
        "Đặt lịch hẹn ký hợp đồng thành công! Vui lòng đến đúng giờ đã chọn."
      );
  ...
  return (
    <div className="max-w-xl mx-auto bg-white rounded-lg shadow-md p-6 mt-8">
      <h2 className="text-2xl font-bold text-center mb-6 text-blue-800">
        Đặt lịch hẹn ký hợp đồng gia hạn
      </h2>
      {loading ? (
        ...
        <>
          <div className="mb-6 bg-gray-50 p-4 rounded">
            <div className="mb-2">
              <span className="font-semibold">Phòng:</span> {contract.number}
            </div>
            <div className="mb-2">
            ...
            <div className="mb-2">
              ...
              <span className="text-blue-700 font-bold">{daysLeft} ngày</span>
            </div>
          </div>
          {!canRenew ? (
            <div className="text-center text-yellow-600 font-semibold text-lg py-8">
              Chưa đến kỳ gia hạn hợp đồng. Bạn chỉ có thể đặt lịch khi còn dưới
              1 tháng (31 ngày) trước ngày kết thúc hợp đồng.
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-blue-700 font-semibold mb-2">
                  Chọn ngày đến ký hợp đồng gia hạn tại Văn phòng KTX:
                </label>
                <input
                  type="datetime-local"
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Vui lòng chọn ngày và giờ bạn sẽ đến ký hợp đồng tại văn phòng
                  KTX.
                </p>
              </div>
              <button
